...
export class CustomerModel {
    ...
    static async findByCcAndCreate(customer:any){
    ...
    static async updatePartialCustomer(data: Customer): Promise<Customer | null> {
        try {
    ...
    static async countCustomer():Promise<Customer> {
        try{
            const {rows} = await connection.query(`
